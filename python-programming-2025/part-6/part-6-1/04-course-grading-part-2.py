...
def print_total_points(students: dict, exercises: dict, points: dict):
	for student_id in exercises:
		...
		print(f"{students[student_id]} {grade}")
...
print_total_points(students_dict, courses_dict, points_dict)